...
class _QrShareScreenState extends State<QrShareScreen>
  ...
  Future<void> _generateSecureQr() async {
    ...
    try {
      ...
      final qrData = await consentManager.generateSecureQrData(abha);
      ...
      _pollingTimer = Timer.periodic(const Duration(seconds: 2), (timer) async {
        ...
        final pollAbha = (DataMode.activeUserId == DataMode.arjunId) ? Persona.abhaAddress : '';
        if (pollAbha.isNotEmpty) await cm.pollForRequests(pollAbha);
  ...
  void _revokeQr() {
    ...
    if (cm.pendingRequest != null) {
      final revokeAbha = (DataMode.activeUserId == DataMode.arjunId) ? Persona.abhaAddress : '';
      cm.sendResponse(revokeAbha, cm.pendingRequest!.requestId, 'REVOKED');
    }
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          const SizedBox(height: 20),
                          Text(
                            (DataMode.activeUserId == DataMode.arjunId) ? Persona.abhaAddress : 'Your ABHA',
                          ...
                          Text(
                            (DataMode.activeUserId == DataMode.arjunId) ? "ABHA: ${Persona.abhaNumber}" : '',
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            (DataMode.activeUserId == DataMode.arjunId) ? Persona.abhaAddress : 'ABHA Verified',
